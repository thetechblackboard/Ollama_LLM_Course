# Ollama_LLM_Course:
1. This course is designed for beginners to quickly get started with Learning Ollama, interacting with LLM models.
2. Secondly, this series will also help beginners to learn python and understand understand basic flow: How python code executes.

** a) Simple-Ollama-call.py:**
